...
namespace CSS
{
    ...
    String^ FindNewFileName(SyncRootViewModel^ srvm, String^ ParentDirectory, String^ filename, String^ extension, CloudItem^ ci, bool ConvertToPh)
    {
        int i = 0;
    ...
    String^ FindNewNameItem(SyncRootViewModel^ srvm, String^ parentFullPath, CloudItem^ ci, bool ConvertToPh)
    {
        ...
        return FindNewFileName(srvm, parentFullPath, Name, extension, ci, ConvertToPh);
    }
}
